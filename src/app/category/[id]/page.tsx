...
export default function CategoryPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 font-sans text-gray-900">
            ...
            <div className="flex justify-between items-center text-xs text-gray-600 bg-gray-100/60 p-2.5 rounded-xs border border-gray-200">
              ...
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-2">
                  <span onClick={() => setSortBy('recommend')} className={`cursor-pointer hover:underline ${sortBy === 'recommend' ? 'text-red-600 font-bold' : ''}`}>v 추천순</span>
                  <span>|</span>
      ...
      <SpecFinderWidget onSelectSpecFilter={() => {}} />
      <CartDrawer />
      <Footer />
    </div>
  );
