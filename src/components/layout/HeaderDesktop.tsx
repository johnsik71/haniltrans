...
export default function HeaderDesktop() {
  ...
  return (
    <div className="w-full bg-white flex flex-col">
      ...
      <div className="bg-slate-900 text-slate-300 text-xs py-2 px-4 w-full">
        <div className="max-w-7xl mx-auto w-full flex justify-between items-center">
          <div className="flex items-center gap-4 text-slate-300">
            ...
            <span className="text-slate-400 hidden lg:inline">오후 4시 전 주문 당일 발송!</span>
          </div>
      ...
      <div className="w-full px-4 lg:px-6 py-4 bg-white">
      ...
      <nav className="bg-slate-900 border-t border-slate-800 text-white w-full px-4 lg:px-6 text-xs font-bold h-12">
