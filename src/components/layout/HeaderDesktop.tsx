...
export default function HeaderDesktop() {
  ...
  return (
    <div className="w-full bg-white border border-gray-200 shadow-sm overflow-hidden flex flex-col rounded-b-xl">
      ...
      <div className="bg-slate-900 text-slate-300 text-xs py-2 px-4 w-full">
        <div className="w-full flex justify-between items-center">
          <div className="flex items-center gap-4 text-slate-300">
            ...
            <span className="text-slate-400">오후 4시 전 주문 당일 발송!</span>
          </div>
      ...
      <div className="w-full px-6 py-4 bg-white flex items-center justify-between gap-6">
        {/* Logo */}
        ...
        <div className="flex flex-1 gap-3 items-center justify-end">
          ...
          {/* Certifications */}
          <div className="hidden xl:flex items-center gap-2 shrink-0 px-2">
          ...
          <button
            ...
            className="flex items-center gap-3 px-4 py-2.5 bg-blue-50 border border-blue-200 text-blue-900 rounded-xl hover:bg-blue-100 transition-colors shrink-0"
          >
      ...
      <nav className="bg-slate-900 border-t border-slate-800 text-white w-full px-6 flex items-center justify-between text-xs font-bold h-12">
        ...
        <div className="flex items-center text-yellow-400 font-bold text-[11px]">
